...
class PhoneBookManager
{
    ...
    HashSet<PhoneInfo> hash = new HashSet<>();
    ...
    private PhoneInfo readFriendInfo()
    {
        ...
        return new PhoneInfo(rName,rPhoneNumber);
    }
    ...
    private PhoneInfo readUnivInfo()
    {
        ...
        return new PhoneUnivInfo(rName,rPhoneNumber, rMajor,rYear);
    }
    ...
    private PhoneInfo readCompanyInfo()
    {
        ...
        return new PhoneCompanyInfo(rName,rPhoneNumber,rCompany);
    }
    ...
    public void DataSearch()
    {
        ...
        while (itr.hasNext())
        {
            ...
            if (SearchName.compareTo(currentInfo.name) == 0){
                info = currentInfo;
            }
        }
...
public class PhoneBookVer07Test
{
